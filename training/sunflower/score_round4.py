"""
Applies the frozen score_and_tier.py logic (unchanged since round 1) to the round-4 extraction
results. Zero new satellite calls -- pure scoring of already-extracted features. Mirrors
score_round3.py exactly.

Run: python3 score_round4.py
"""
import json
from score_and_tier import score_and_tier_all
from collections import Counter

d = json.load(open("haryana_round4_results.json"))
results = d["results"]
...
json.dump(scored, open("haryana_round4_scored.json", "w"), indent=2)
print("Saved haryana_round4_scored.json")
